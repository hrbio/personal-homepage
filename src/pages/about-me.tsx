	...
	return (
		<TextSection title='O mnie'>
			<p>
				...
				controllingu. Moje CV znajdziesz na <a href='https://google.com' target={'blank'} className='text-neutral-500 border-dashed border-neutral-500 hover:text-neutral-400 hover:border-neutral-500 border-b'>githubie</a>.
			</p>
		</TextSection>
	);
};
